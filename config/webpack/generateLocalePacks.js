...
const localesJsonPath = path.join(__dirname, '../../app/javascript/kahlu/locales');
...
locales.forEach(locale => {
  ...
  const localeDataPath = [
    ...
    `../../app/javascript/kahlu/locales/locale-data/${baseLocale}.js`,
...
//
import messages from '../../app/javascript/kahlu/locales/${locale}.json';
import localeData from ${JSON.stringify(localeDataPath)};
import { setLocale } from '../../app/javascript/kahlu/locales';
