          ...
          <div className='account__section-headline'>
            <div style={{width: '100%', display: 'flex'}}>
              <NavLink exact to={`/${accountUsername}`}>
                <FormattedMessage id='account.posts' defaultMessage='Shouts' />
              </NavLink>
              <NavLink exact to={`/${accountUsername}/with_replies`}>
                <FormattedMessage id='account.posts_with_replies' defaultMessage='Shouts and replies' />
              </NavLink>
